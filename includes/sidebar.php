                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="/admin/view_customers.php">View Customers</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="/admin/view_sales.php">View Sales</a></li>
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown nxl-h-item nxl-header-search">
                        <a href="javascript:void(0);" class="nxl-head-link me-0" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <i class="feather-search d-none"></i>
                        </a>
                    ...
                    <div class="dropdown nxl-h-item nxl-header-language d-sm-flex">
                        <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link">
                            <img src="/dist/assets/vendors/img/flags/4x3/ir.svg" alt="Iran Flag" class="img-fluid wd-20" />
                        </a>
                    </div>
